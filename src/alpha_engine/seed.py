...
_SAMPLES = [
    ...
    ("careers", Category.QUANT_FIRMS, [Approach.MACHINE_LEARNING, Approach.INFRA_DATA],
     ItemType.HIRING, Region.INDIA, None,
     "[Graviton Research Capital] Quantitative Researcher — Systematic Strategies (Gurugram)",
     "One of India's largest HFT firms is hiring quant researchers in Gurugram to build and deploy automated systematic trading strategies on Indian and global markets.",
     "Signals where a top Indian HFT is investing — systematic strategy research on NSE/BSE, a route into quant trading without leaving India."),
    ("rss", Category.QUANT_FIRMS, [Approach.INFRA_DATA],
     ItemType.LAUNCH, Region.GLOBAL, WorkflowStage.EXECUTION,
     "MarketAxess launches an AI execution tool that finds the best venue for large bond trades",
     "A capital-markets platform shipped a tool that scans venues in real time and routes big fixed-income orders to wherever they'll move the price least.",
     "You can now cut the hidden cost of moving size in bonds by letting the tool pick the cheapest place to trade instead of guessing."),
